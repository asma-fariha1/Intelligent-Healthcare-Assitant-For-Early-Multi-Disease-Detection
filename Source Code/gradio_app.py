...
def process_inputs(audio_filepath, image_filepath):
    if not audio_filepath:
        return "No audio recorded", "No response generated (no audio provided)", None
...
iface.launch(debug=True, share=True, prevent_thread_lock=False,show_error=True, inbrowser=True)
